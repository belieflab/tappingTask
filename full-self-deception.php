...
<div id="errorMessageHolder" class="error centeredDiv">
  ...
  <script>
    ...
    var train_stimuli_array = []; /* I believe this creates an array that holds the trial information. Does this need to be done in a for loop? */
    for (var i = 0; i < 3; i++){
      train_stimuli_array.push("Stimuli/Hangul_E" + i + ".bmp");
    }

    var c1_train_stimuli = [ // This is also building the trial structure here as well //
    ...
    var c1_train = { // I think this is the object for collecting responses //
